...
[`@aws-sdk/client-internetmonitor`](https://www.npmjs.com/package/@aws-sdk/client-internetmonitor/v/3.596.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-internetmonitor@3.596.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-xmkbQM1STpL4nC5SbywzGvakLPfL5j5QIiuVQYDMVZgl1DvQCEObgpGi7zeND2v6
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-internetmonitor": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-internetmonitor@3.596.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-internetmonitor@3.596.0/index.min.mjs": "sha384-xmkbQM1STpL4nC5SbywzGvakLPfL5j5QIiuVQYDMVZgl1DvQCEObgpGi7zeND2v6"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-internetmonitor/blob/refs/tags/3.596.0/LICENSE
```
