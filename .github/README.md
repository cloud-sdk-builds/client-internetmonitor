...
[`@aws-sdk/client-internetmonitor`](https://www.npmjs.com/package/@aws-sdk/client-internetmonitor/v/3.1034.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-internetmonitor@3.1034.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-POmHSY12aDmJpbRS+eAakNi78RComClRLSHBG2wKn+UvIRFLoVy//a+42idYmlR0
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-internetmonitor": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-internetmonitor@3.1034.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-internetmonitor@3.1034.0/index.min.mjs": "sha384-POmHSY12aDmJpbRS+eAakNi78RComClRLSHBG2wKn+UvIRFLoVy//a+42idYmlR0"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-internetmonitor/blob/refs/tags/3.1034.0/LICENSE
```
